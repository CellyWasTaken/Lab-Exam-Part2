...
public class SightingReader
{
     ...
     */
    public ArrayList<SerengetiSighting> getSightings(String filename)
    {
        // Create a Sighting from a CSV input line.
        Function<String, SerengetiSighting> createSighting = 
            record -> {
                           ...
                           if(parts.length == NUMBER_OF_FIELDS) {
                               try {
                                   ...
                                   return new SerengetiSighting(animal, spotter, count, area, period);
                               }
        ...
        ArrayList<SerengetiSighting> sightings;
        try {
